...
<g:applyLayout name="taskContent">
    ...
    <div class="pain-chart-neck task-content">
        <div class="task-list-wrapper container">
            ...
            <form action="" method="post" data-draft="${Draft}" data-no-pain-control="[0, 19]">
                    ...
                    <div class="answer-list odi-style">
                        <div class="select-contain">
                            <span class="select-group">
                                <select class="select-menu" name="choices.16" data-title="BACK PAIN"
                                        data-mobile-dialog-event="showMobileSelectMenuDialog">
                                    <g:each var="j" in="${(0..<10)}">
                                        <option value="${j * 10}"
                                                <g:if test="${Draft?.'16' == (j * 10).toString()}">selected</g:if>>${j * 10}</option>
                                    </g:each>
                                </select>
                            ...
                            <span class="select-group">
                                <select class="select-menu" name="choices.17" data-title="BUTTOCK PAIN"
                                        data-mobile-dialog-event="showMobileSelectMenuDialog">
                                    <g:each var="j" in="${(0..<10)}">
                                        <option value="${j * 10}"
                            ...
                            <span class="select-group">
                                <select class="select-menu" name="choices.18" data-title="LEG PAIN"
                                        data-mobile-dialog-event="showMobileSelectMenuDialog">
                                    <g:each var="j" in="${(0..<10)}">
                                        <option value="${j * 10}"
                        ...
                        <li class="answer">
                            <span id="no-pain-choice" class="inline">
                                ...
                                <label class="choice">
                                    <input id="no-pain-toggle" type="checkbox" name="choices.19" value="on"
                                        ...
                                        <li class="answer">
                                            ...
                                            <label class="choice choice-number choice-number-${j}">
                                                <input type="radio" class="rc-choice-hidden"
                                                       name="choices.${20 + 2 * i}"
                                                       <g:if test="${Draft && Draft[(20 + 2 * i).toString()] == j.toString()}">checked</g:if>
                                                       value="${j}"/>
                                ...
                                <ul class="list horizontal-list">
                                    ...
                                    <g:each var="j" in="${0..<6}">
                                        <li class="answer">
                                            ...
                                            <label class="choice">
                                                <input type="radio" class="rc-choice-hidden"
                                                       name="choices.${20 + 2 * i + 1}"
                                                       <g:if test="${Draft && Draft[(20 + 2 * i + 1).toString()] == j.toString()}">checked</g:if>
                                                       value="${j}"/>
                                                <span class="rc-radio"></span>
                                            </label>
                                        </li>
