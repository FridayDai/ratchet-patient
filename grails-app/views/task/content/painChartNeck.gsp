                    ...
                    <div class="answer-list odi-style">
                        <div class="select-contain">
                            <span class="select-group">
                                <select class="select-menu" name="choices.9" data-mobile-dialog-event="showMobileSelectMenuDialog">
                            ...
                            <span class="select-group">
                                <select class="select-menu" name="choices.10" data-mobile-dialog-event="showMobileSelectMenuDialog">
                                    <g:each var="j" in="${(0..<10)}">
                            ...
                            <span class="select-group">
                                <select class="select-menu" name="choices.11" data-mobile-dialog-event="showMobileSelectMenuDialog">
                                    <g:each var="j" in="${(0..<10)}">
