        ...
        <g:if test="${tasksList}">
            ...
            <div id="task-list-active">
                <g:render template="/multiTask/template/taskUL"
                          model="[tasksList: tasksList, treatmentCode: treatmentCode, isInClinic: isInClinic]"/>
            </div>
            ...
            <g:if test="${isSingleTask}">
                <div class="task-list-container">
                    <span class="task-complete-list">
                        <p class="task-title-tip"><span class="task-done"></span><span
                                class="task-index"></span>${taskTitle}</p>
                    </span>
                </div>
            </g:if>
                ...
                <div class="task-list-container">
                    <span class="task-complete-list">
                        ...
                        <g:each in="${doneTaskList}" var="${completeTask}" status="i">
                            <p class="task-title-tip"><span class="task-done"></span><span
                                    class="task-index"></span>${completeTask.title}</p>
                        </g:each>
                    </span>
                </div>
